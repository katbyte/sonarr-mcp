...
func TestOperationPutConfigDownloadClientById(t *testing.T) {
	...
	result, err := c.PutConfigDownloadClientById(t.Context(), "p/id", DownloadClientConfigResource{})
	if err != nil {
		t.Fatal(err)
	}
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodPut, "/api/v3/config/downloadclient/p%2Fid")
