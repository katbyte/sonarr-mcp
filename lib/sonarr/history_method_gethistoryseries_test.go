...
func TestOperationGetHistorySeries(t *testing.T) {
	t.Parallel()

	c, s := newOperationServer(t, 200, "application/json", "[{}]")
	result, err := c.GetHistorySeries(t.Context(), GetHistorySeriesOperationOptions{
		SeriesId:       7,
		SeasonNumber:   7,
		EventType:      EpisodeHistoryEventTypeUnknown,
	...
	r, body := s.only(t)
	_ = body
	expectRequest(t, r, http.MethodGet, "/api/v3/history/series")
